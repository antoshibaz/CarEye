# testing cascade+hogsvm classifiers for traffic signs detection
import time
...
hogsvm_path = "../../resourses/svm/triang_rect_signs_hogsvm_detector_rbf_kfold10.xml"
...
detector = TrafficSignsDetector(cascade_path, hogsvm_path, trafficSignHog)
test_counter = 1
for i in range(5):
    if i == 0:
        scale = 1.2
    ...
    for j in range(7):
        ...
        for a in test_annotations:
            ...
            detected_objects, calcSignsHogs = detector.find(img, scale, neighbors, min_size, max_size)
